...
export function Footer() {
  ...
  return <footer className="site-footer"><div className="section-shell footer-grid">
    ...
    <nav className="footer-nav" aria-label={t.footer.navAria}><p>{t.footer.explore}</p><Link to={path("/flowers")}>{t.footer.collection}</Link><Link to={path("/#occasions")}>{t.footer.occasions}</Link><Link to={path("/#florist-choice")}>{t.footer.florist}</Link><Link to={path("/#custom")}>{t.footer.custom}</Link></nav>
